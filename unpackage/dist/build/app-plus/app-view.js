...
var aZ=_mz(z,'view',['bindtap',16,'class',1,'data-event-opts',2],[],e,s,gg)
var t1=_n('text')
...
var x5=_mz(z,'navigator',['class',23,'hoverClass',1,'openType',2,'url',3],[],e,s,gg)
var o6=_n('text')
...
var oHB=_mz(z,'button',['plain',-1,'bindtap',39,'class',1,'data-event-opts',2,'formType',3],[],e,s,gg)
...
var z=gz$gwx_4()
var xOC=_n('view')
var oPC=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var fQC=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(oPC,fQC)
var cRC=_n('view')
...
var tYC=_mz(z,'navigator',['navigateTo',-1,'class',9,'hoverClass',1,'style',2,'url',3],[],oVC,cUC,gg)
var eZC=_n('view')
_rz(z,eZC,'class',13,oVC,cUC,gg)
var b1C=_oz(z,14,oVC,cUC,gg)
_(eZC,b1C)
_(tYC,eZC)
var o2C=_n('view')
_rz(z,o2C,'class',15,oVC,cUC,gg)
var x3C=_oz(z,16,oVC,cUC,gg)
_(o2C,x3C)
_(tYC,o2C)
var o4C=_n('text')
_rz(z,o4C,'class',17,oVC,cUC,gg)
_(tYC,o4C)
_(lWC,tYC)
return lWC
}
hSC.wxXCkey=2
_2z(z,7,oTC,e,s,gg,hSC,'item','index','index')
_(oPC,cRC)
var f5C=_n('view')
...
var xGD=_mz(z,'navigator',['navigateTo',-1,'class',9,'hoverClass',1,'style',2,'url',3],[],eDD,tCD,gg)
var oHD=_n('view')
_rz(z,oHD,'class',13,eDD,tCD,gg)
var fID=_oz(z,14,eDD,tCD,gg)
_(oHD,fID)
_(xGD,oHD)
var cJD=_n('view')
_rz(z,cJD,'class',15,eDD,tCD,gg)
var hKD=_oz(z,16,eDD,tCD,gg)
_(cJD,hKD)
_(xGD,cJD)
var oLD=_n('text')
_rz(z,oLD,'class',17,eDD,tCD,gg)
_(xGD,oLD)
_(bED,xGD)
return bED
}
lAD.wxXCkey=2
_2z(z,7,aBD,e,s,gg,lAD,'item','index','index')
_(o8C,o0C)
var cMD=_n('view')
...
var z=gz$gwx_7()
var tQD=_n('view')
var eRD=_mz(z,'swiper',['autoplay',0,'circular',1,'class',1,'duration',2,'indicatorDots',3,'interval',4],[],e,s,gg)
var bSD=_v()
_(eRD,bSD)
...
var oZD=_v()
_(hYD,oZD)
if(_oz(z,10,oVD,xUD,gg)){oZD.wxVkey=1
var o2D=_mz(z,'image',['mode',11,'src',1],[],oVD,xUD,gg)
_(oZD,o2D)
}
var c1D=_v()
_(hYD,c1D)
if(_oz(z,13,oVD,xUD,gg)){c1D.wxVkey=1
var l3D=_mz(z,'video',['autoplay',-1,'loop',-1,'controls',14,'muted',1,'objectFit',2,'showPlayBtn',3,'src',4],[],oVD,xUD,gg)
_(c1D,l3D)
}
oZD.wxXCkey=1
c1D.wxXCkey=1
...
var o0D=_n('view')
var fAE=_n('view')
_rz(z,fAE,'class',23,b7D,e6D,gg)
var cBE=_n('view')
_rz(z,cBE,'class',24,b7D,e6D,gg)
var hCE=_n('text')
_rz(z,hCE,'class',25,b7D,e6D,gg)
_(cBE,hCE)
var oDE=_oz(z,26,b7D,e6D,gg)
_(cBE,oDE)
_(fAE,cBE)
_(o0D,fAE)
var cEE=_n('view')
_rz(z,cEE,'class',27,b7D,e6D,gg)
var oFE=_v()
_(cEE,oFE)
var lGE=function(tIE,aHE,eJE,gg){
var oLE=_n('view')
_rz(z,oLE,'class',32,tIE,aHE,gg)
var xME=_n('navigator')
_rz(z,xME,'url',33,tIE,aHE,gg)
var oNE=_mz(z,'view',['class',34,'style',1],[],tIE,aHE,gg)
var fOE=_v()
_(oNE,fOE)
if(_oz(z,36,tIE,aHE,gg)){fOE.wxVkey=1
var cPE=_n('view')
_rz(z,cPE,'class',37,tIE,aHE,gg)
var hQE=_v()
_(cPE,hQE)
if(_oz(z,38,tIE,aHE,gg)){hQE.wxVkey=1
var oRE=_oz(z,39,tIE,aHE,gg)
_(hQE,oRE)
}
hQE.wxXCkey=1
_(fOE,cPE)
...
oFE.wxXCkey=2
_2z(z,30,lGE,b7D,e6D,gg,oFE,'item','index','index')
_(o0D,cEE)
_(o8D,o0D)
return o8D
}
a4D.wxXCkey=2
_2z(z,21,t5D,e,s,gg,a4D,'menu','indexMenu','indexMenu')
_(r,tQD)
return r
}
...
var o2E=_mz(z,'home',['bind:__l',1,'vueId',1],[],e,s,gg)
_(tWE,o2E)
}
var eXE=_v()
_(aVE,eXE)
if(_oz(z,3,e,s,gg)){eXE.wxVkey=1
var f3E=_mz(z,'basics',['bind:__l',4,'vueId',1],[],e,s,gg)
_(eXE,f3E)
}
var bYE=_v()
_(aVE,bYE)
if(_oz(z,6,e,s,gg)){bYE.wxVkey=1
var c4E=_mz(z,'components',['bind:__l',7,'vueId',1],[],e,s,gg)
_(bYE,c4E)
}
var oZE=_v()
_(aVE,oZE)
if(_oz(z,9,e,s,gg)){oZE.wxVkey=1
var h5E=_mz(z,'plugin',['bind:__l',10,'vueId',1],[],e,s,gg)
_(oZE,h5E)
}
var x1E=_v()
_(aVE,x1E)
if(_oz(z,12,e,s,gg)){x1E.wxVkey=1
var o6E=_mz(z,'about',['bind:__l',13,'vueId',1],[],e,s,gg)
_(x1E,o6E)
}
var c7E=_n('view')
_rz(z,c7E,'class',15,e,s,gg)
var o8E=_mz(z,'view',['bindtap',16,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var l9E=_n('view')
_rz(z,l9E,'class',20,e,s,gg)
var a0E=_n('image')
_rz(z,a0E,'src',21,e,s,gg)
_(l9E,a0E)
_(o8E,l9E)
var tAF=_n('view')
...
_(o8E,tAF)
_(c7E,o8E)
var bCF=_mz(z,'view',['bindtap',24,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var oDF=_n('view')
_rz(z,oDF,'class',28,e,s,gg)
var xEF=_n('image')
_rz(z,xEF,'src',29,e,s,gg)
_(oDF,xEF)
_(bCF,oDF)
var oFF=_n('view')
...
_(bCF,oFF)
_(c7E,bCF)
var cHF=_mz(z,'view',['bindtap',32,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var hIF=_n('view')
_rz(z,hIF,'class',36,e,s,gg)
var oJF=_n('image')
_rz(z,oJF,'src',37,e,s,gg)
_(hIF,oJF)
_(cHF,hIF)
var cKF=_n('view')
_rz(z,cKF,'class',38,e,s,gg)
var oLF=_oz(z,39,e,s,gg)
_(cKF,oLF)
_(cHF,cKF)
_(c7E,cHF)
var lMF=_mz(z,'view',['bindtap',40,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var aNF=_n('view')
_rz(z,aNF,'class',44,e,s,gg)
var tOF=_n('image')
_rz(z,tOF,'src',45,e,s,gg)
_(aNF,tOF)
_(lMF,aNF)
var ePF=_n('view')
...
_(lMF,ePF)
_(c7E,lMF)
var oRF=_mz(z,'view',['bindtap',48,'class',1,'data-cur',2,'data-event-opts',3],[],e,s,gg)
var xSF=_n('view')
_rz(z,xSF,'class',52,e,s,gg)
var oTF=_n('image')
_rz(z,oTF,'src',53,e,s,gg)
_(xSF,oTF)
_(oRF,xSF)
var fUF=_n('view')
_rz(z,fUF,'class',54,e,s,gg)
var cVF=_oz(z,55,e,s,gg)
_(fUF,cVF)
_(oRF,fUF)
_(c7E,oRF)
_(aVE,c7E)
...
_(cYF,a2F)
_(oXF,cYF)
var e4F=_mz(z,'form',['bindsubmit',9,'data-event-opts',1],[],e,s,gg)
var b5F=_n('view')
_rz(z,b5F,'class',11,e,s,gg)
var o6F=_n('text')
_rz(z,o6F,'class',12,e,s,gg)
_(b5F,o6F)
var x7F=_mz(z,'input',['name',13,'placeholder',1,'style',2],[],e,s,gg)
_(b5F,x7F)
_(e4F,b5F)
var o8F=_n('view')
...
_(o8F,f9F)
var c0F=_mz(z,'input',['name',18,'placeholder',1,'style',2,'type',3],[],e,s,gg)
_(o8F,c0F)
_(e4F,o8F)
var hAG=_n('view')
_rz(z,hAG,'class',22,e,s,gg)
var oBG=_mz(z,'button',['class',23,'formType',1],[],e,s,gg)
var cCG=_oz(z,25,e,s,gg)
_(oBG,cCG)
_(hAG,oBG)
var oDG=_mz(z,'button',['plain',-1,'class',26,'formType',1],[],e,s,gg)
...
var z=gz$gwx_10()
var tGG=_n('view')
var eHG=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var bIG=_mz(z,'cu-custom',['bgImage',1,'bind:__l',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var oJG=_n('view')
_rz(z,oJG,'slot',5,e,s,gg)
var xKG=_mz(z,'image',['mode',6,'src',1,'style',2],[],e,s,gg)
_(oJG,xKG)
_(bIG,oJG)
_(eHG,bIG)
var oLG=_n('view')
...
var lSG=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2,'data-url',3,'style',4],[],oPG,hOG,gg)
var aTG=_n('view')
_rz(z,aTG,'class',19,oPG,hOG,gg)
var tUG=_oz(z,20,oPG,hOG,gg)
_(aTG,tUG)
_(lSG,aTG)
_(cQG,lSG)
return cQG
